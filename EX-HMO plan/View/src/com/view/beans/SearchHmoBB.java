...
public class SearchHmoBB {
    ...
    public String addMedicalDetailsAction() {
        ...
        ADFContext.getCurrent().getPageFlowScope().put("PersonId", r.getAttribute("PartyId"));
        ADFContext.getCurrent().getPageFlowScope().put("PartyId", r.getAttribute("PartyId"));
        ADFContext.getCurrent().getPageFlowScope().put("PersonNo", r.getAttribute("ContactPartyNumber"));
        ADFContext.getCurrent().getPageFlowScope().put("Title", r.getAttribute("PersonTitle"));
        ADFContext.getCurrent().getPageFlowScope().put("FirstName", r.getAttribute("PersonFirstName"));
        ADFContext.getCurrent().getPageFlowScope().put("LastName", r.getAttribute("PersonLastName"));
