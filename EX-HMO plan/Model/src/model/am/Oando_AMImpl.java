...
import model.vo.ExEmpAttachment_EOViewImpl;
...
public class Oando_AMImpl extends ApplicationModuleImpl implements ApplicationModule, Oando_AM {
    ...
    public BigDecimal getPersonId(String userName) {
        ...
        if (vo.getEstimatedRowCount() > 0) {
            personId = (BigDecimal) vo.first().getAttribute("PartyId");
    ...
    public void createNewHMO() {
        ...
        String userName = ADFContext.getCurrent()
                                    ...
                                    .toString();
        try {
            Number partyId = new Number(getPersonId(userName));
            ...
            if (vo.getEstimatedRowCount() > 0) {
                ...
                empName =
                    r.getAttribute("EmployeeFullName") != null ? r.getAttribute("EmployeeFullName").toString() : "";
                empNumber =
                    r.getAttribute("ContactPartyNumber") != null ? r.getAttribute("ContactPartyNumber").toString() : "";
                email = r.getAttribute("EmailAddress") != null ? r.getAttribute("EmailAddress").toString() : "";
                // deptName = r.getAttribute("DepartmentName")!=null?r.getAttribute("DepartmentName").toString():"";
                title = r.getAttribute("PersonTitle") != null ? r.getAttribute("PersonTitle").toString() : "";
                firstName =
                    r.getAttribute("PersonFirstName") != null ? r.getAttribute("PersonFirstName").toString() : "";
                lastName = r.getAttribute("PersonLastName") != null ? r.getAttribute("PersonLastName").toString() : "";
            }
            ...
            newRow.setPersonId(partyId);
            BigDecimal number = new BigDecimal(partyId.toString());
            newRow.setPartyId(number);
            ...
            newRow.setAlternateEmail(email);
    ...
    public ArrayList employee_photo_details(BigDecimal hdr_id, BigDecimal person_id, String hmo_type,
                                            String hmo_category, String hmo_option) {
        //        String p_errorMessgae = null;
        //                String p_errorCode =null;
    ...
    public ArrayList getEmpHmoCost(double p_hmo_master_hdr_id, String p_hmo_type, long p_person_id,
                                   String p_hmo_category, String p_hmo_option, String p_emp_dob,
                                   String p_addi_category) {
        ArrayList list = new ArrayList();

        System.out.println("---------getEmpHmoCost-----Entering method----------");

        System.out.println("p_hmo_master_hdr_id----" + p_hmo_master_hdr_id);
        System.out.println("p_hmo_type-----" + p_hmo_type);
        System.out.println("p_person_id-----" + p_person_id);
        System.out.println("p_hmo_category-------" + p_hmo_category);
        System.out.println("p_hmo_option--------" + p_hmo_option);
        System.out.println("p_emp_dob----------" + p_emp_dob);
        System.out.println("p_addi_category---------" + p_addi_category);

        CallableStatement st = null;
        try {
            System.out.println("inside callable stat ---------");
                   DateFormat inputFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        //    DateFormat inputFormat = new SimpleDateFormat("dd-MM-yyyy");

            java.util.Date depday = inputFormat.parse(p_emp_dob);
            java.sql.Date depDate = new java.sql.Date(depday.getTime());
            System.out.println("inside callable stat one ---------");
            ...
            // list.add(638061.01);
            list.add(st.getDouble(1));
            System.out.println("after executing plsql stat ---------");
    ...
    /**
     * Container's getter for ExEmpAttachment_EOView1.
     * @return ExEmpAttachment_EOView1
     */
    public ExEmpAttachment_EOViewImpl getExEmpAttachment_EOView() {
        return (ExEmpAttachment_EOViewImpl) findViewObject("ExEmpAttachment_EOView");
    }

    /**
        * Container's getter for XxhrDtl_ExEmpAttach_VL1.
        * @return XxhrDtl_ExEmpAttach_VL1
        */
    //    public ViewLinkImpl getXxhrDtl_ExEmpAttach_VL1() {
    //        return (ViewLinkImpl) findViewLink("XxhrDtl_ExEmpAttach_VL1");
    //    }
     ...
     * @return ExEmpAttachment_EOView1
     */
    public ExEmpAttachment_EOViewImpl getExEmpAttachment_EOView1() {
        return (ExEmpAttachment_EOViewImpl) findViewObject("ExEmpAttachment_EOView1");
    }
