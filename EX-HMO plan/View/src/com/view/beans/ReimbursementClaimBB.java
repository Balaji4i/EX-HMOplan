...
public class ReimbursementClaimBB {
    ...
    private boolean callSubmitPayload() {
        ViewObject mediVo = com.view
                               .uiutils
                               .ADFUtils
                               .findIterator("HMOReimbursement_VOIterator")
                               .getViewObject();
        ...
        String reimbursementId =
            r.getAttribute("ReimbursementId") != null ? r.getAttribute("ReimbursementId").toString() : "";
        ...
        String policyHolderName =
            r.getAttribute("PolicyHolderName") != null ? r.getAttribute("PolicyHolderName").toString() : "";
        String stateOfResi =
        ...
        String hospNameUsed =
            r.getAttribute("HospitalNameUsed") != null ? r.getAttribute("HospitalNameUsed").toString() : "";
        ...
        String reason =
            r.getAttribute("ReasonForReimbursement") != null ? r.getAttribute("ReasonForReimbursement").toString() : "";
        String enrolleeBank = r.getAttribute("EnrolleeBank") != null ? r.getAttribute("EnrolleeBank").toString() : "";
        String enrolleeBankAcc =
            r.getAttribute("EnrolleeBankAccount") != null ? r.getAttribute("EnrolleeBankAccount").toString() : "";
        String bankAccName =
            r.getAttribute("BankAccountName") != null ? r.getAttribute("BankAccountName").toString() : "";
        ...
        String reimbursementReqNo =
            r.getAttribute("ReimbursementReqNo") != null ? r.getAttribute("ReimbursementReqNo").toString() : "";

        String xmlData =
            ApprovalPayload.reimbursementChangesXMLData(reimbursementId, year, hmo_ref, personId, personNo, title,
                                                        first_name, last_name, mobileNo, email, policyHolderName,
                                                        stateOfResi, hospital, hospNameUsed, dateofVisit, emergency,
                                                        hmoProvider, reason, enrolleeBank, enrolleeBankAcc, bankAccName,
                                                        reqType, comments, status, reimbursementReqNo);


        System.err.println("xmlData =>" + xmlData);
        a = ApprovalProcess.invokeWsdl(xmlData, ApprovalPayload.REIMBURSEMENT_WSDL,
                                       ApprovalPayload.REIMBURSEMENT_CHANGE_METHOD);
        ...
        if (vce.getNewValue() != null) {
            ...
            if (myfile != null) {
                ViewObject vo = com.view
                                   .uiutils
                                   .ADFUtils
                                   .findIterator("Reimbursement_Attachment_VOIterator")
                                   .getViewObject();
