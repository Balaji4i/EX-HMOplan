...
public class CardReplacementBB {
    ...
    public void onUploadFileVCL(ValueChangeEvent vce) {
        if (vce.getNewValue() != null) {
            ...
            if (myfile != null) {
                ViewObject vo = com.view.uiutils.ADFUtils.findIterator("CardAttachment_VoIterator").getViewObject();
    ...
    public void onDownloadProof(FacesContext facesContext, OutputStream outputStream) {
        ViewObject hdrVo = com.view.uiutils.ADFUtils.findIterator("CardAttachment_VoIterator").getViewObject();
    ...
    private boolean callSubmitPayload() {
      ...
      //  ADFUtils.findOperation("Commit").execute();
        ...
        if (a[0] != null && a[0].equals("True")) {
            ADFUtils.findOperation("Commit").execute();
            com.view.utils.JSFUtils.addFacesInformationMessage("Card Replacement Form Submitted Successfully !!");
            return true;
        } else {
