...
public class XxhrHmoTrxHdr_EOViewRowImpl extends ViewRowImpl {
    ...
    public static final int ATTACHMENTCOUNT = AttributesEnum.AttachmentCount.index();
    ...
    public static final int EXEMPATTACHMENT_EOVIEW = AttributesEnum.ExEmpAttachment_EOView.index();
    ...
    public Number getBusinessUnitId() throws SQLException {
        ...
        if (getPersonId() != null) {
            ...
            vcr.setAttribute("PartyId", number);
            vc1.addRow(vcr);
            ...
            //            Row[] orgRows;
            //            orgRows = getxxperEmployee_V_ROVO1().getFilteredRows("PartyId", number);
            //            if (orgRows.length > 0) {
            ...
            //            type = getPersonId();
            //            Row[] orgRows;
            //            orgRows = getxxperEmployee_V_ROVO1().getFilteredRows("PartyId", type);
            //            if (orgRows.length > 0) {
...
//            } else 
            if (!"Traditional Dependent Categorization".equals(hmoCateg)) {
                ...
                if ("AXAMANSARD HEALTH".equals(hmoType) || "LEADWAY HEALTH STANDARD".equals(hmoType) ||
                    "RELIANCE HEALTH".equals(hmoType)) {
                    if ("Traditional Dependent Categorization".equals(hmoCateg)) {
                        if (hmoOptions.equals("Employee Only") || "EMP_ONLY".equals(hmoOptions)) {
            ...
            if (("BUPA".equals(hmoType) || "CIGNA".equals(hmoType)) ||
                ...
                if (a >= b) {
                    ...
                    return new BigDecimal(0);
                        ...
                        "Traditional Dependent Categorization".equals(hmoCategory)) ||
                       ("AXAMANSARD HEALTH".equals(hmoType) &&
                        "Traditional Dependent Categorization".equals(hmoCategory))) {
    ...
    public String getEmpName_Trans() {
        ...
        if (getPersonId() != null) {
            ...
            if (vo1.getEstimatedRowCount() > 0) {
                Row rw = vo1.first();
                name =
                    rw.getAttribute("EmployeeFullName") != null ? rw.getAttribute("EmployeeFullName").toString() : "";
            }
    ...
    public String getEmpNumber_Trans() {
        ...
        if (getPersonId() != null) {
            ...
            if (vo1.getEstimatedRowCount() > 0) {
                Row rw = vo1.first();
                name =
                    rw.getAttribute("ContactPartyNumber") != null ? rw.getAttribute("ContactPartyNumber").toString() :
                    "";
            }
            return name;
        } else {
    ...
    public BigDecimal getTrans_NairaEquAmount() {
        ...
        return (BigDecimal) (nairaEquAmt.multiply(new BigDecimal(575)));
    ...
    public String getTrans_Title() {
        ...
        if (getPersonId() != null) {
            ...
            ViewRowSetImpl vo = (ViewRowSetImpl) getxxperEmployee_V_ROVO1();
            // System.out.println("Vo----" + vo.getViewObject());
            ViewObject vo1 = vo.getViewObject();
            ...
            vo1.applyViewCriteria(vc1);
            vo1.executeQuery();
            System.out.println("Get Query ---" + vo1.getQuery());
            if (vo1.getEstimatedRowCount() > 0) {
                Row rw = vo1.first();
    ...
    public String getTrans_FirstName() {
        ...
        if (getPersonId() != null) {
            ...
            ViewRowSetImpl vo = (ViewRowSetImpl) getxxperEmployee_V_ROVO1();
            ViewObject vo1 = vo.getViewObject();
            System.out.println(" Get View Object ---" + vo1);
            ViewCriteria vc1 = vo1.createViewCriteria();
            ViewCriteriaRow vcr = vc1.createViewCriteriaRow();
            vcr.setAttribute("PartyId", number);
            vc1.addRow(vcr);
            vo1.applyViewCriteria(vc1);
            vo1.executeQuery();
            System.out.println("First Name " + vo1.getQuery());
            if (vo1.getEstimatedRowCount() > 0) {
                Row rw = vo1.first();
                name = rw.getAttribute("PersonFirstName") != null ? rw.getAttribute("PersonFirstName").toString() : "";
            }
            return name;
        } else {
    ...
    public String getTrans_LastName() {
        ...
        if (getPersonId() != null) {
            ...
            if (vo1.getEstimatedRowCount() > 0) {
                Row rw = vo1.first();
                name = rw.getAttribute("PersonLastName") != null ? rw.getAttribute("PersonLastName").toString() : "";
            }
            return name;
        } else {
    ...
    public String getTrans_Entity() {
        ...
        if (getPersonId() != null) {
            ...
            //            Row[] orgRows;
            //            orgRows = getEntity_ROVO().getFilteredRows("PartyId", number);
            //            if (orgRows.length > 0) {
    ...
    public String getTrans_DateofBirth() {
        ...
        if (getPersonId() != null) {
            type = getPersonId();
            System.out.println("Inside dob method-----");
            BigDecimal number = new BigDecimal(type.toString());
            ...
            if (vo1.getEstimatedRowCount() > 0) {
                ...
                if (rw.getAttribute("DateOfBirth") != null) {
                    Date dobDate = (Date) rw.getAttribute("DateOfBirth");
                    name = formatter.format(dobDate);
                    System.out.println("DOB After format----------" + name);
                }
            }
    ...
    /**
     * Gets the attribute value for the calculated attribute AttachmentCount.
     * @return the AttachmentCount
     */
    public String getAttachmentCount() {
        return (String) getAttributeInternal(ATTACHMENTCOUNT);
    }
    ...
    /**
     * Gets the associated <code>RowIterator</code> using master-detail link ExEmpAttachment_EOView.
     */
    public RowIterator getExEmpAttachment_EOView() {
        return (RowIterator) getAttributeInternal(EXEMPATTACHMENT_EOVIEW);
    }
